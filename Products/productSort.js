...
document.addEventListener('DOMContentLoaded', () => {
  const descendingButton = document.querySelector('.u-btn-submit-descending');
  const ascendingButton = document.querySelector('.u-btn-submit-ascending');
    console.log(descendingButton);
  descendingButton.addEventListener('click', (event) => {
    event.preventDefault();
    var searchApiUrl = `${apiUrl}/all?sortPrice=desc`;
  ...
  ascendingButton.addEventListener('click', (event) => {
    event.preventDefault(); // Prevent default form submission
    var searchApiUrl =  `${apiUrl}/all?sortPrice=asc`;
    console.log(searchApiUrl);
    fetch(searchApiUrl)
      .then(response => response.json())
      .then(data => {
